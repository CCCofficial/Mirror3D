# do all pairs
# movement detector using Median Filter
# Tom Z 5.29.23
...
#vid=r'C:\Users\820763897\Videos\microscope\Mirror Microscope\Diana\Stentor Reflection Project\Dark_D.mp4' #minArea=5 maxArea=181 thresh=34
vid=r'C:\Users\820763897\Videos\microscope\Mirror Microscope\Diana\Stentor Reflection Project\Dark_B.mp4' 
vid=r'C:\Users\820763897\Pictures\Camera Roll\planktonMirrorCage\blep8.mp4'
vid=r'C:\Users\820763897\Videos\CCC\MirrorMicroscope\8.29 bubble stentor.mov'
#id=r'C:\Users\820763897\Videos\CCC\MirrorMicroscope\8.29 full stentor.mov'
...
FRAME,INDEX,XC,YC,ZC,XR,YR,RADIUS_C,RADIUS_R,SLOPE_C,SLOPE_R,SLOPE_MUTUAL,PAIRED,SAVE=range(MAX_COL_OBJ) #XC,YC,ZC=real object XR,YR=reflection
header='FRAME,INDEX,XC,YC,ZC,XR,YR,RADIUS_C,RADIUS_R,SLOPE_C,SLOPE_R,SLOPE_MUTUAL,PAIRED,SAVE'
dataFileName='3D_Detect_1.csv'
data=np.zeros((0,MAX_COL_OBJ))
#dataVector=np.zeros((1,MAX_COL))

keyState=0;
keyBuf=np.zeros((256),dtype=int)

keyBuf[ord('b')]=1  # blur size
keyBuf[ord('t')]=27 # threshold after blur
keyBuf[ord('a')]=19 # min area an object must have
keyBuf[ord('A')]=641 # max area
keyBuf[ord('w')]=42 # max width height
...
def plotXYZ(obj,frameCount,xList,yList,zList):
    ...
    if frameCount%PLOT_UPDATE_FRAME==0:
...
# quit program 
#np.savetxt(dataFileName,data,header=header,delimiter=',',fmt='%int')  
